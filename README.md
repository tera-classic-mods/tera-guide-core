...
Official fork of tera-guide-core to support classic private servers.
...
The guides based on this module can be found here: https://github.com/tera-classic-mods/tera-guide
...
* **Library** (Classic) - https://github.com/tera-classic-toolbox/library
* **badgui-fix** - https://github.com/tera-classic-toolbox/badgui-fix
...
```json
{
    ...
    "dependencies": {
        "library": "https://raw.githubusercontent.com/tera-classic-toolbox/library/master/module.json",
